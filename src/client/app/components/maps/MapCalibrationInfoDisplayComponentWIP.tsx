...
import { EntityType, localEditsSlice, selectEntityDisplayData } from '../../redux/slices/localEditsSlice';
...
export default function MapCalibrationInfoDisplayComponent() {
	...
	const showGrid = useAppSelector(state => state.localEdits.mapCalibration.calibrationSettings.showGrid);
	const [mapData] = useAppSelector(state => selectEntityDisplayData(state, {
		type: EntityType.MAP, id: state.localEdits.mapCalibration.calibratingMap
	}));
